...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptsChicago = depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo);
        List<Emp> result = emps.Where(e => deptsChicago.Contains(e.DeptNo)).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => true, g => true, (emp, grade) => new { emp, grade })
            ...
            .Select(grp => new {grp.emp.EName, grp.grade.Grade});
