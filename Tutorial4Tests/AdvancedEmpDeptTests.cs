...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, e => e.Mgr, mgr => mgr.EmpNo, (e, mgr) => new {Employee = e.EName, Manager = mgr.EName});
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(e => new {e.EName, Total = e.Sal + e.Comm.GetValueOrDefault(0)});
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(grades, e => true, g => true, (emp, grade) => new { emp, grade })
            .Where(grp => grp.emp.Sal >= grp.grade.Losal && grp.emp.Sal < grp.grade.Hisal)
            .Select(grp => new { grp.emp.EName, grp.emp.DeptNo, grp.grade.Grade })
            .Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new { e.EName, d.DName, e.Grade });
